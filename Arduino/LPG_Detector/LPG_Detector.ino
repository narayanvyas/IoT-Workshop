...
// Global Varibales
int buzzer = 7;
int sensorPin = A3;  // Variable to control Gas Sensor (MQ 6 - Data will be received in Analog Form)
int redLed = 5;
int greenLed = 6;
int sensorValue;
...
void loop() {
  ...
  Serial.println(sensorValue);  // Printing the sensor value to Serial Monnitor
